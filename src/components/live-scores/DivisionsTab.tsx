...
const AGE_GROUPS: AgeGroup[] = [
  ...
  },
  {
    ...
    ageRange: 'Ages 8–12',
    color: '#4A9EFF',
    description: 'Where technique becomes the focus. Athletes start developing power and precision. Athletes in this division are 8–12 years old.',
    levels: [
      { name: 'Novice', badge: 'NOV', age: '8–12', skills: 'Basic jumps, beginner stunts, simple choreography', note: 'Entry level' },
      { name: 'Prep', badge: 'PREP', age: '8–12', skills: 'Prep-level stunts, simple basket tosses, beginner tumbling' },
      { name: 'Level 1', badge: 'L1', age: '8–12', skills: 'Extended stunts, cartwheel/round-off, basic pyramids' },
      { name: 'Level 2', badge: 'L2', age: '8–12', skills: 'Extended stunts with twists, round-off back handspring' },
      { name: 'Level 3', badge: 'L3', age: '8–12', skills: 'Inversions, back tucks, more complex pyramid connections' },
      { name: 'Level 4', badge: 'L4', age: '8–12', skills: 'Advanced inversions, layouts, intricate pyramids' },
      { name: 'NT 2–4', badge: 'NT', age: '8–12', skills: 'National Team levels — highest difficulty, World bid eligible', note: 'Elite / Worlds pathway' },
    ],
  },
  {
    id: 'u16',
    ...
    ageRange: 'Ages 12–16',
    color: COLORS.gold,
    description: 'Skill demand rises significantly. Tumbling passes get harder, stunts more creative. Athletes in this division are 12–16 years old.',
    levels: [
      { name: 'Novice', badge: 'NOV', age: '12–16', skills: 'Fundamentals focus, beginner stunts', note: 'Entry level' },
      { name: 'Prep', badge: 'PREP', age: '12–16', skills: 'Prep-level stunts, beginner basket tosses' },
      { name: 'Level 1', badge: 'L1', age: '12–16', skills: 'Extended stunts, cartwheel/round-off tumbling' },
      { name: 'Level 2', badge: 'L2', age: '12–16', skills: 'Extended stunts with twists, round-off back handspring' },
      { name: 'Level 3', badge: 'L3', age: '12–16', skills: 'Inversions, back tucks, single-leg variations' },
      { name: 'Level 4', badge: 'L4', age: '12–16', skills: 'Advanced inversions, layouts, intricate pyramids, full twists' },
      { name: 'Level 5', badge: 'L5', age: '12–16', skills: 'Elite stunts, double-down basket tosses, full-twisting layouts' },
      { name: 'Level 6', badge: 'L6', age: '12–16', skills: 'Top elite — high-risk inversions, complex pyramids, elite tumbling' },
      { name: 'NT 2–6', badge: 'NT', age: '12–16', skills: 'National Team — World bid eligible, highest difficulty per level', note: 'Worlds pathway' },
    ],
  },
  {
    id: 'u18',
    ...
    ageRange: 'Ages 13–18',
    color: COLORS.coral,
    description: 'The most competitive junior age group. Levels 5–7 and NT divisions are where many of the best Canadian teams compete for World bids. Athletes are 13–18 years old.',
    levels: [
      { name: 'Novice', badge: 'NOV', age: '13–18', skills: 'Fundamentals, beginner stunts', note: 'Entry level' },
      { name: 'Prep', badge: 'PREP', age: '13–18', skills: 'Prep stunts, beginner basket tosses' },
      { name: 'Level 1–4', badge: 'L1–4', age: '13–18', skills: 'Progressive skill difficulty from cartwheel to advanced inversions' },
      { name: 'Level 4.2', badge: 'L4.2', age: '13–18', skills: 'Transition level between L4 and L5 — elite L4 skills' },
      { name: 'Level 5', badge: 'L5', age: '13–18', skills: 'Double-down basket tosses, full-twisting layouts, elite pyramids' },
      { name: 'Level 6', badge: 'L6', age: '13–18', skills: 'High-risk skills, complex multi-person pyramids, elite tumbling' },
      { name: 'Level 7', badge: 'L7', age: '13–18', skills: 'Highest difficulty — elite inversions, double twists, World-level skills' },
      { name: 'AG Level 5–7', badge: 'AG', age: '13–18', skills: 'All-Girl version of L5–7 — no male athletes' },
      { name: 'Coed Level 5–7', badge: 'CO', age: '13–18', skills: 'Mixed gender — additional stunt difficulty allowed' },
      { name: 'NT 2–7', badge: 'NT', age: '13–18', skills: 'National Team — World bid eligible, top teams in Canada', note: 'Worlds pathway' },
    ],
  },
  {
    id: 'open',
    label: 'Open',
    ageRange: 'Ages 14+ (no max)',
    color: COLORS.magenta,
    description: 'No upper age limit. Athletes must be at least 14. This is where senior athletes and adults compete. Open Level 5–7 and NT are the pinnacle of Canadian All-Star cheerleading.',
    levels: [
